...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<List<Object[]>> stack;
    ...
    public BTree(int order) {
        ...
        maxDegree = 2 * order;
        stack = new ArrayDeque<List<Object[]>>();
    }
    ...
    public void insert(T value) {
        ...
        if (root == null) {
            ...
            while (currentNode != null && !wasAdded) {
            	Object [] bt = new Object [3];
            	// If the node has 2t-1 keys then split it
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                	Object [] bt2 = new Object [3];
                	T keyForBt = currentNode.getKey((currentNode.numOfKeys)/2);
                	split(currentNode);
                	bt2 [0] = currentNode; 
                	bt2 [1] = BTreeActionType.SPLIT;
                    ...
                    bt2 [2] = currentNode.indexOf(keyForBt);
                    LL.add(0, bt2);
                ...
                if (currentNode.isLeaf()) {
                	...
                	bt [0] = currentNode;
                	bt [1] = BTreeActionType.NONE;
                	currentNode.addKey(value);
                	bt [2] = currentNode.indexOf(value);
                	wasAdded = true;
                } else {
                	bt [0] = currentNode;
                	bt [1] = BTreeActionType.NONE;
