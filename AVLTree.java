...
public class AVLTree implements Iterable<Integer> {
	...
	protected Node insertNode(Node node, int value) {
        Object[] bt = new Object[2];
	    // Perform regular BST insertion
        if (node == null) {
        	Node insertedNode = new Node(value);
        	bt[0] = ImbalanceCases.NO_IMBALANCE;
        	bt[1] = insertedNode;
        	stack.push(bt);
            return insertedNode;
        }
        ...
        if (balance > 1) {
            if (value > node.left.value) {
                ...
                bt[0] = ImbalanceCases.LEFT_RIGHT;
            }
            else {
            	bt[0] = ImbalanceCases.LEFT_LEFT;
            }
            ...
            if (value < node.right.value) {
                ...
                bt[0] = ImbalanceCases.RIGHT_LEFT;
            }
            else {
            	bt[0] = ImbalanceCases.RIGHT_RIGHT;
            }
